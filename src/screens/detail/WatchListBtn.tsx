...
import { addToWacthlist, removeFromWacthlist } from "../../store/reducers/watchlist/actions";
...
const WatchListBtn: React.FC<WatchListBtnProps> = () => {
  ...
  return (
    <Pressable onPress={() => actions[isAdded ? "removeFromWacthlist" : "addToWacthlist"](movie)}>
